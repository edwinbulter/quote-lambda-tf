...
async function listUsers(): Promise<UserInfo[]> {
    ...
    return withRetry(
        async () => {
            const response = await fetch(`${getApiBaseUrl()}/manage/users`, {
                method: "GET",
                headers: {
                    ...authHeaders,
                },
...
async function addUserToGroup(username: string, groupName: string): Promise<void> {
    ...
    return withRetry(
        async () => {
            const response = await fetch(`${getApiBaseUrl()}/manage/users/role`, {
                method: "PUT",
                headers: {
                    ...authHeaders,
...
async function deleteUser(username: string): Promise<void> {
    ...
    return withRetry(
        async () => {
            const response = await fetch(`${getApiBaseUrl()}/manage/users/account`, {
                method: "DELETE",
                headers: {
                    ...authHeaders,
                    "Content-Type": "application/json",
...
async function getQuotes(
    ...
    return withRetry(
        async () => {
            const response = await fetch(`${getApiBaseUrl()}/manage/quotes?${params.toString()}`, {
                method: "GET",
                headers: {
                    ...authHeaders,
                },
...
async function fetchAndAddNewQuotes(): Promise<QuoteAddResponse> {
    ...
    return withRetry(
        async () => {
            const response = await fetch(`${getApiBaseUrl()}/manage/quotes/fetch`, {
                method: "POST",
                headers: {
                    ...authHeaders,
                },
...
async function getTotalLikes(): Promise<{ totalLikes: number; timestamp: string }> {
    ...
    return withRetry(
        async () => {
            const response = await fetch(`${getApiBaseUrl()}/manage/stats`, {
                method: "GET",
                headers: {
                    ...authHeaders,
                },
